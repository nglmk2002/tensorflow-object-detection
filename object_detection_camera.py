...
PATH_TO_LABELS = 'C:\\Users\\ASUS\\Documents\\GitHub\\tensorflow-object-detection\\data\\models\\ssd_mobilenet_v2_320x320_coco17_tpu-8\\mscoco_label_map.pbtxt'
...
if cap.isOpened() == False :
    ...
    #반복문이 필요한 이유? 비디오는 여러사진으로 구성되어있으니까 
    while cap.isOpened() :
        #사진을 1장씩 가져와서
        ret, frame = cap.read()
        #제대로 사진 가져왓으면 화면에 표시
